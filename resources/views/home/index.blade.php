        ...
        <div class="div">
            ...
            <div class="group">
                ...
                <div class="group-2">
                    ...
                    <div class="group-3">
                       <a href="category/1"> <div class="text-wrapper-2">t-shirts</div></a>
                       <a href="category/2"> <div class="text-wrapper-3">stationary</div></a>
                       <a href="category/3"> <div class="text-wrapper-4">accessories</div></a>
                    </div>
                </div>
                <div class="group-4">
            ...
            <div class="group-11">
                ...
                <div class="card-t-shirts">
                    ...
                    <div class="vector-wrapper"><img class="vector-2" src="{{ asset('img/cardvector.svg') }}" /></div>
